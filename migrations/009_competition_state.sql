...
-- Tiny K/V scratchpad for the competition scheduler's persistent state.
-- Replaces the old KV cursor pattern per @whoabuddy's #738 review note that
...
--
-- Schema is intentionally generic — future scheduler state (last_run_at,
