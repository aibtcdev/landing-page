...
export default function Home() {
  ...
  return (
    <>
      {/* Animated Background - GPU accelerated for smooth mobile scrolling */}
      <div
        className="fixed inset-0 -z-10 h-[100dvh] w-full overflow-hidden bg-gradient-to-br from-black via-[#0a0a0a] to-[#050208] will-change-transform [backface-visibility:hidden] [transform:translate3d(0,0,0)]"
        aria-hidden="true"
      >
        {/* Background Pattern - optimized for fast loading */}
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.12] saturate-[1.3] [backface-visibility:hidden]"
          style={{ backgroundImage: `url('${basePath}/Artwork/AIBTC_Pattern1_optimized.jpg')` }}
        />

        {/* Orbs - GPU accelerated */}
        <div className="absolute -right-[200px] -top-[250px] h-[800px] w-[800px] rounded-full bg-[radial-gradient(circle,rgba(247,147,26,0.4)_0%,rgba(247,147,26,0.15)_40%,transparent_70%)] opacity-70 blur-[100px] will-change-transform [backface-visibility:hidden] animate-float1" />
        <div className="absolute -bottom-[250px] -left-[200px] h-[700px] w-[700px] rounded-full bg-[radial-gradient(circle,rgba(125,162,255,0.35)_0%,rgba(125,162,255,0.12)_40%,transparent_70%)] opacity-60 blur-[100px] will-change-transform [backface-visibility:hidden] animate-float2" />
        <div className="absolute bottom-[20%] -right-[150px] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle,rgba(125,162,255,0.2)_0%,rgba(125,162,255,0.08)_40%,transparent_70%)] opacity-40 blur-[100px] will-change-transform [backface-visibility:hidden] max-md:hidden animate-float1-reverse" />
