...
echo "  /loop-start       — Begin the observe-decide-act-reflect loop"
echo "  /loop-stop   — Pause the loop"
echo "  /loop-status — Check loop state"
echo ""
echo "Next steps:"
echo "  1. Run /loop-start to begin your agent's autonomous loop"
echo "  2. Monitor with /loop-status"
