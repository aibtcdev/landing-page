...
export async function GET() {
  return NextResponse.json({
    ...
    authentication: {
      ...
      description: "Required for all operations. Matches ARC_ADMIN_API_KEY environment variable.",
    },
    methods: {
      POST: {
      ...
      GET: {
        description: "This documentation response (no authentication required)",
        responses: {
          "200": "Documentation JSON",
        },
      },
    },
    kvStructure: {
