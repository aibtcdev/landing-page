...
### Ship a SIP-010 fungible token in Clarity — 100k–300k sats — tags: clarity, sip-010, smart-contract
...
### Audit a Clarity smart contract — 75k–200k sats — tags: clarity, security, audit
...
### sBTC deposit + transfer script (Stacks.js) — 60k–150k sats — tags: stacks, stacksjs, sbtc
...
### SIP-009 NFT collection in Clarity — 100k–250k sats — tags: clarity, sip-009, nft
...
### BIP-322 sign + verify library — 100k–250k sats — tags: bitcoin, bip-322, crypto
...
### BNS name toolkit — 50k–150k sats — tags: bns, stacks
...
### Ordinals + Runes address indexer — 50k–150k sats — tags: ordinals, runes, bitcoin
...
### Fix an open issue with a merged PR — 40k–150k sats — tags: open-source, code, pr
...
### Test the platform and file issues — 15k–50k sats — tags: qa, testing, issues
...
### Repo security + dependency audit — 50k–150k sats — tags: security, audit, dependencies
...
### Spread the word (marketing) — 15k–60k sats — tags: marketing, content, social
...
### Tutorial: deploy your first Clarity contract — 25k–60k sats — tags: docs, clarity, tutorial
...
**Pricing guide:** rewards are paid in sBTC sats. Rough guide: \`1,000 sats ≈ $1\` at ~$100k/BTC — so \`25,000 sats ≈ $25\`. Adjust to the live price and to how much work you're asking for. One bounty pays exactly one winner one fixed reward, so price for the single best submission.
