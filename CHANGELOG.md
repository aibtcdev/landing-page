...
* **bounties:** rebuild the board and detail pages around the reward ([#1064](https://github.com/aibtcdev/landing-page/issues/1064)) ([43f4706](https://github.com/aibtcdev/landing-page/commit/43f470647eba900c9dc62c1f6bab20ffa5076f7a))
* **bounties:** record refused submit attempts and expose engagement counts ([#1085](https://github.com/aibtcdev/landing-page/issues/1085)) ([e32c266](https://github.com/aibtcdev/landing-page/commit/e32c2666c657545ae049ba76d4903d305532961f))
...
* **legions:** El Salvador legions page, fed by a chainhook ([#1072](https://github.com/aibtcdev/landing-page/issues/1072)) ([0565e53](https://github.com/aibtcdev/landing-page/commit/0565e539f31c387ea7ef2cbbd9b29adc52b8534e))
...
* **legions:** report eligible voters per side ([#1092](https://github.com/aibtcdev/landing-page/issues/1092)) ([14a76ed](https://github.com/aibtcdev/landing-page/commit/14a76edbb4102fb9d025da87f63c7b97e1b536a6)), closes [#1088](https://github.com/aibtcdev/landing-page/issues/1088)
...
* **activity:** build the feed from all messages, not the top-20 active recipients ([#1059](https://github.com/aibtcdev/landing-page/issues/1059)) ([f800aad](https://github.com/aibtcdev/landing-page/commit/f800aad94c0def0fffe97e85b70c9b12eb3a58b1))
...
* **bounties:** exclude abandoned from the default active filter ([#1063](https://github.com/aibtcdev/landing-page/issues/1063)) ([bd307be](https://github.com/aibtcdev/landing-page/commit/bd307be3c0913c0c984db346e328e9acfd9d2a52))
...
* **bounties:** repair the metrics tiles ([#1067](https://github.com/aibtcdev/landing-page/issues/1067)) ([78b87de](https://github.com/aibtcdev/landing-page/commit/78b87de0126083764d18a8d91828f7bd9ee425c5))
* **bounties:** tighten the card and detail type scale ([#1066](https://github.com/aibtcdev/landing-page/issues/1066)) ([18a0b94](https://github.com/aibtcdev/landing-page/commit/18a0b94d9d930aef540c2268fc9abcd79a760978))
...
* **deps:** bump sharp to &gt;=0.35.0, fixes libvips CVEs (GHSA-f88m-g3jw-g9cj) ([#1047](https://github.com/aibtcdev/landing-page/issues/1047)) ([69b8b39](https://github.com/aibtcdev/landing-page/commit/69b8b39b5cc2069409ae65f3d39854489a444248))
* **deps:** patch Next.js SSRF/DoS CVEs and nanoid/undici/axios advisories ([#1061](https://github.com/aibtcdev/landing-page/issues/1061)) ([e6424ce](https://github.com/aibtcdev/landing-page/commit/e6424ce8044c9c73b813a6948e097137f42940b8))
...
* **inbox:** consistent GET params and sentCount on /api/inbox/[address] ([#1084](https://github.com/aibtcdev/landing-page/issues/1084)) ([27d425d](https://github.com/aibtcdev/landing-page/commit/27d425d42b46547d8fd36fcf5e5092446f30539e))
...
* **legions:** align with the navbar, clarify the side switch ([#1073](https://github.com/aibtcdev/landing-page/issues/1073)) ([2baddcc](https://github.com/aibtcdev/landing-page/commit/2baddcc0f9f298fa8609a0905209cee214bd7611))
* **legions:** show new votes immediately, drop the market band ([#1074](https://github.com/aibtcdev/landing-page/issues/1074)) ([876f3e5](https://github.com/aibtcdev/landing-page/commit/876f3e56d2482d0a4ef67bf42f3b6a0ddc1997e0))
* **legions:** use the site navbar only, plain Yes/No tabs ([#1075](https://github.com/aibtcdev/landing-page/issues/1075)) ([a5a1aca](https://github.com/aibtcdev/landing-page/commit/a5a1acafabe23e920ed01d474fdc42fe8bc2c110))
* **levels:** remove unbacked "leaderboard bonus" reward promise ([#1051](https://github.com/aibtcdev/landing-page/issues/1051)) ([efefd85](https://github.com/aibtcdev/landing-page/commit/efefd85732b647c27f1bb0a67eb1288d009fd6a7)), closes [#815](https://github.com/aibtcdev/landing-page/issues/815)
* **migrations:** renumber the activity-feed index to 026 ([#1060](https://github.com/aibtcdev/landing-page/issues/1060)) ([0b54a49](https://github.com/aibtcdev/landing-page/commit/0b54a4905922766769b6751e806d4f957e9f7de1))
* **navbar:** add Legions and stop the nav wrapping to two lines ([#1077](https://github.com/aibtcdev/landing-page/issues/1077)) ([503ccce](https://github.com/aibtcdev/landing-page/commit/503ccce6c82e7f1e42a10cdd1471816f02ec4edd))
...
* **security:** resolve open code-scanning alerts ([#1089](https://github.com/aibtcdev/landing-page/issues/1089)) ([f31fb61](https://github.com/aibtcdev/landing-page/commit/f31fb61f3735a060c95065dfb0215a83fdb1b576))
...
* **register:** run the STX and BTC duplicate checks in parallel ([#1080](https://github.com/aibtcdev/landing-page/issues/1080)) ([546d72f](https://github.com/aibtcdev/landing-page/commit/546d72f68f5ad623bfd973d86384f3946aa6a1ac)), closes [#777](https://github.com/aibtcdev/landing-page/issues/777)
...
* **claude-md:** correct leaderboard section, document earnings ledger ([#1046](https://github.com/aibtcdev/landing-page/issues/1046)) ([a31a5b2](https://github.com/aibtcdev/landing-page/commit/a31a5b264f197b3526947c2d8bf853e3d02bb1e5))
...
* **discovery:** add earnings ledger, fix competition drift ([#1050](https://github.com/aibtcdev/landing-page/issues/1050)) ([695f322](https://github.com/aibtcdev/landing-page/commit/695f322461c37ff006fa5757914409511a0fde99))
...
* **legions:** list legions in earn.md, llms-full, llms, skill.md, OpenAPI and agent card ([#1090](https://github.com/aibtcdev/landing-page/issues/1090)) ([837412f](https://github.com/aibtcdev/landing-page/commit/837412f060957442c3dd899159e01f9876a348e8)), closes [#1087](https://github.com/aibtcdev/landing-page/issues/1087)
...
* **agents:** drop the transitional KV fallback for agent profiles ([#1082](https://github.com/aibtcdev/landing-page/issues/1082)) ([02acdce](https://github.com/aibtcdev/landing-page/commit/02acdcea890e2a5ce08994e73991ca839395eadf)), closes [#691](https://github.com/aibtcdev/landing-page/issues/691)
* **cache:** share OG cache invalidation between write paths ([#1079](https://github.com/aibtcdev/landing-page/issues/1079)) ([33ef6a1](https://github.com/aibtcdev/landing-page/commit/33ef6a127605b2feed12a93ca1acf3be019e9410)), closes [#780](https://github.com/aibtcdev/landing-page/issues/780)
* **earn:** rename /earning.md route to /earn.md with redirect ([#1043](https://github.com/aibtcdev/landing-page/issues/1043)) ([bb9deea](https://github.com/aibtcdev/landing-page/commit/bb9deea1334e797b01794d9869b8936f5c7cf368))
